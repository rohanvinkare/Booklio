    ...
    return (
        <section className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
                ...
                <p className="mt-2 text-gray-600 dark:text-neutral-400 max-w-xl mx-auto text-sm sm:text-base">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Link to="/auth/login" className="text-center group">
                    <div className="flex justify-center items-center w-20 h-20 sm:w-16 sm:h-16 bg-gray-50 border border-gray-200 rounded-full mx-auto dark:bg-neutral-800 dark:border-neutral-700 transition-transform group-hover:scale-105">
                    ...
                    <h3 className="mt-4 text-lg font-semibold text-gray-800 dark:text-white">Buy Books</h3>
                    <div className="mx-10">
                        <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">Browse, compare, and purchase from thousands of books.</p>
                    </div>
                </Link>
                ...
                <Link to="/auth/seller/login" className="text-center group">
                    ...
                    <h3 className="mt-4 text-lg font-semibold text-gray-800 dark:text-white">Sell Books</h3>
                    <div className="mx-10">
                        <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">List your old books and earn by selling directly to readers.</p>
                    </div>
                ...
                <Link to="/auth/login" className="text-center group">
                    ...
                    <h3 className="mt-4 text-lg font-semibold text-gray-800 dark:text-white">Track Orders</h3>
                    <div className="mx-10">
                        <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">Stay updated with real-time delivery status of all your orders.</p>
                    </div>
                </Link>
            </div>
        </section>

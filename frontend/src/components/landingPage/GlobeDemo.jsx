...
export function GlobeDemo() {
    ...
    // return (
    //     <div 
    //         className="flex flex-row items-center justify-center py-20 h-screen mt-10 mb-10 md:h-auto dark:bg-[#060606] bg-white relative w-full">
    //         <div
    ...
    //     <section
    //         ref={ref}
    //         className="min-h-screen w-full flex items-center justify-center bg-[#060606] text-white px-6 transition-all duration-500"
    //     >
    ...
    //                     Only on <span className="text-blue-600">Booklio</span>.
    //                 </h1>
    ...
    //                 className="w-full h-[24rem] md:h-[36rem] relative z-10"
    //             >
    //                 <World data={sampleArcs} globeConfig={globeConfig} />
    //             </motion.div>
    //         </div>

...
const Testimonials = () => {
    return (
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            {/* Grid */}
            <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between ml-4   ">
                    ...
                    <div className="mb-8">
                        <h2 className="mb-2 text-3xl text-gray-800 font-bold lg:text-4xl dark:text-neutral-200">
                            <GradientText
                                ...
                                animationSpeed={10}
                                showBorder={false}
                            > More than just books</GradientText>
                        </h2>
                        <p className="text-gray-600 dark:text-neutral-400">
                            Booklio isn’t just a platform—it’s a growing community of readers,
                            collectors, and story-lovers. We’re redefining how books are
                            bought, shared, and cherished.
                        </p>
                    </div>
                    ...
                    <blockquote className="relative">
                        ...
                        <div className="relative z-10">
                            <p className="text-xl italic text-gray-800 dark:text-white">
                                "From the moment I joined Booklio, I felt like I belonged. It's
                                the only platform that truly understands a book lover's heart."
                            </p>
                        </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col bg-white border border-gray-200 shadow-2xs rounded-xl dark:bg-neutral-900 dark:border-neutral-700">
                        <div className="flex-auto p-4 md:p-6">
                            ...
                            <p className="mt-3 sm:mt-6 text-base text-gray-800 md:text-xl dark:text-white">
                                <em>
                                    "I will be using Booklio for 2 years. I’ve seen many updates
                                    and changes, and I truly appreciate the consistency and

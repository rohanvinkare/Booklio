...
const Card = ({ image }) => {
  ...
  return (
    <div
      className="relative h-[300px] min-w-[200px] flex justify-center items-center bg-[#060606] overflow-hidden"
    ...
    >
      ...
      {hovered && (
        ...
        >
          {/* Blur Background */}
          <div className="absolute inset-0 bg-[#060606]/50 pointer-events-none" />

          {/* CTA Text */}
          <h1 className="bg-white font-semibold text-sm z-10 px-2 py-2 rounded-full flex items-center gap-[0.5ch] hover:opacity-75 pointer-events-none transition-all">
            <span>Shop Now</span>
            <img
              src={arrowUrl}
              alt="arrow"

...
export default function Loader() {
    ...
    return (
        <div className="relative flex h-screen w-full flex-col items-center justify-center bg-[#0b0b0b] overflow-hidden z-[9999]">
            ...
            {/* Gradient Spinner using pseudo-element */}
            <div className="relative z-20 mb-4 h-12 w-12 rounded-full animate-spin before:content-[''] before:absolute before:inset-0 before:rounded-full before:border-[4px] before:border-transparent before:border-t-[4px] before:[border-image:conic-gradient(#a855f7,#3b82f6,#000000)_1]" />

            {/* Enlarged and spaced Loading Text */}
            <p className="relative z-20 text-xl sm:text-2xl text-gray-200 font-semibold tracking-widest uppercase animate-pulse">
                Loading...
            </p>
        </div>
